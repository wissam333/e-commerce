                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 navigation">
                                            ...
                                            <ul>
                                                ...
                                                <li class="itemes">
                                                    <RouterLink to="/ShopByCategory/electronics" class="dropdown-item">
                                                        <div v-if="mobile" data-bs-toggle="collapse"
                            ...
                            <RouterLink to="/" class="nav-item">
                                <div v-if="mobile" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent">Home
                                </div>
                                <div v-else>Home</div>
                            </RouterLink>

                            <RouterLink to="WhatsNewView" class="nav-item">
                                <div v-if="mobile" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent">What's
                                    New
                                </div>
                            ...
                            <div v-if="item">
                                ...
                                <div class="delete_qty">
                                    <div class="quantity">
                                        ...
                                        <input name="quantity" type="text" class="quantity__input" v-model="item.qty"
                                            min="1">
